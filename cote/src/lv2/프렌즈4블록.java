...
public class 프렌즈4블록 {
    ...
    public void test() {
        ...
        assertEquals(14,solution.solution(4, 5, new String[]{"CCBDE", "AAADE", "AAABF", "CCBBF"}));
        assertEquals(15,solution.solution(6, 6, new String[]{"TTTANT", "RRFACC", "RRRFCC", "TRRRAA", "TTMMMF", "TMMTTJ"}));
    }
}
